...
if __name__ == "__main__":
    ...
    file_name = "F:/Polito/ICTinBuildingdesign/Building_project/ouput2.txt"
    ...
    w_cooling,result_cooling,error1 = MSE(target_cooling ,domain,"cooling_sim2")
    w_heating,result_heting,error2 = MSE(target_heating ,domain,"heating_sim2")
    
    write_output(result_cooling,error1,"result_cooling_sim2",num_train,density_train)
    write_output(result_heting,error2,"result_heating_sim2",num_train,density_train)
    
    file_test = "F:/Polito/ICTinBuildingdesign/Building_project/ouput2_test.txt"
    ...
    result_cooling_test,error1_test = test(target_cooling_test ,domain_test,w_cooling,"cooling_test 2")
    result_heting_test,error2_test = test(target_heating_test ,domain_test,w_heating,"heating_test 2")
    
    write_output(result_cooling_test,error1_test,"result_cooling_test 2",numb_test,density_test)
    write_output(result_heting_test,error2_test,"result_heating_test 2",numb_test,density_test)
