...
if __name__ == "__main__":
    ...
    result_cooling,error1 = MSE(target_cooling ,domain,"cooling_sim2")
    result_heting,error2 = MSE(target_heating ,domain,"heating_sim2")
    
    write_output(result_cooling,error1,"result_cooling_sim2")
    write_output(result_heting,error2,"result_heating_sim2")
